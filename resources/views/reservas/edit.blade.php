...
@section('head')
    ...
    <script>
        var seccion_id = 2;
        var fecha = '{{ date("d/m/Y", strtotime($reserva->fecha)) }}';
        var reserva_id = {{ $reserva->id }};
        var cantidad = {{ $reserva->cantidad }};
    </script>    
@endsection
...
<div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::select('usuarios[]', $usuarios, $reserva->usuario_id, ['class'=>'form-control select-usuarios', 'id' => 'usuarios']) !!}
            </div> 
